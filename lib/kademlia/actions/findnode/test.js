...
const mock_1 = require("../../modules/peer/mock");
...
function testSetupNodes(kBucketSize, num) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const offer = mock_1.PeerModule(kAnswer.kTable.kid);
        const offerSdp = yield offer.createOffer();
        const answer = mock_1.PeerModule(kOffer.kTable.kid);
        ...
        for (let i = 2; i < 2 + num; i++) {
            ...
            const offer = mock_1.PeerModule(push.kTable.kid);
            const offerSdp = yield offer.createOffer();
            const answer = mock_1.PeerModule(pop.kTable.kid);
            const answerSdp = yield answer.setOffer(offerSdp);
            yield offer.setAnswer(answerSdp);
...
describe("findnode", () => {
    test("findnode", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const search = (word) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const node = nodes[0];
            let target;
            for (let pre = ""; pre !== node.kTable.getHash(word); pre = node.kTable.getHash(word)) {
