...
function findNode(searchkid, di) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const findNodeProxy = (peer) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const findNodeProxyOfferResult = yield Promise.all(kTable.findNode(searchkid).map(peer => findNodeProxy(peer)));
