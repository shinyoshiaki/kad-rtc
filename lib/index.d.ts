import Kademlia, { EventManager, Item, KeyValueStore, Peer, PeerModule, genKid } from "./kademlia";
...
export { PeerModule, Kademlia, KeyValueStore, Peer, genKid, storeFile, findFile, StreamVideo, ReceiveVideo, SuperStreamVideo, SuperReceiveVideo, StreamArraybuffer, RenderArraybuffer, EventManager, Item };
